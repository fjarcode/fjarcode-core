...
complete --command fjarcode-qt --no-files

# Extract options
function __fish_codefalconqt_get_options
...
complete \
    --command fjarcode-qt \
    --arguments "(__fish_codefalconqt_get_options --nofiles)"
