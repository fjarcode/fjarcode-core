...
complete --command fjarcoded --no-files

# Extract options
function __fish_codefalcond_get_options
...
complete \
    --command fjarcoded \
    --arguments "(__fish_codefalcond_get_options --nofiles)"
