...
# Extract options
function __fish_codefalcon_tx_get_options
...
# Extract commands
function __fish_codefalcon_tx_get_commands
...
complete \
    --command fjarcode-tx \
    --condition "not __fish_codefalcon_seen_cmd (__fish_codefalcon_tx_get_commands --commandsonly)" \
    --arguments "(__fish_codefalcon_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command fjarcode-tx \
    --arguments "(__fish_codefalcon_tx_get_commands)" \
    --no-files
