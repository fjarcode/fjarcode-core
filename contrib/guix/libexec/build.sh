...
(
    ...
    case "$HOST" in
        *mingw*)
            make deploy ${V:+V=1} FJARCODE_WIN_INSTALLER="${OUTDIR}/${DISTNAME}-win64-setup-unsigned.exe"
            ;;
    esac
    ...
    (
        ...
        # copy over the example fjarcode.conf file. if contrib/devtools/gen-fjarcode-conf.sh
        # has not been run before buildling, this file will be a stub
        cp "${DISTSRC}/share/examples/fjarcode.conf" "${DISTNAME}/"
