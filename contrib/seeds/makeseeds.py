...
def parse_args():
    argparser = argparse.ArgumentParser(description='Generate a list of fjarcode node seed ip addresses.')
...
def main():
    ...
    # Filter out hosts with multiple fjarcode ports, these are likely abusive
    ips = filtermultiport(ips)
    print(f'{ip_stats(ips):s} Filter out hosts with multiple fjarcode ports', file=sys.stderr)
