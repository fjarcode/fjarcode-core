...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef FJARCODE_CHAINPARAMSSEEDS_H\n')
    g.write('#define FJARCODE_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the fjarcode network\n')
    ...
    g.write('#endif // FJARCODE_CHAINPARAMSSEEDS_H\n')
