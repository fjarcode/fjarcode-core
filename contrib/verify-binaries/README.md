...
of the [guix.sigs repository](https://github.com/fjarcode-core/guix.sigs/). When
...
builder-keys](https://github.com/fjarcode-core/guix.sigs/tree/main/builder-keys) and
...
signature file `SHA256SUMS.asc` from https://fjarcodecore.org and https://fjarcode.org.
...
./contrib/verify-binaries/verify.py bin ~/Downloads/SHA256SUMS \
    ~/Downloads/fjarcode-24.0.1-x86_64-linux-gnu.tar.gz \
    ~/Downloads/fjarcode-24.0.1-arm-linux-gnueabihf.tar.gz
```
