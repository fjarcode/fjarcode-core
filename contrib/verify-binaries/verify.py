...
signature file SHA256SUMS.asc from fjarcodecore.org and fjarcode.org and
compares them.
...
The builder keys are available in the guix.sigs repo:
    ...
    https://github.com/fjarcode-core/guix.sigs/tree/main/builder-keys
...
HOST1 = "https://fjarcodecore.org"
HOST2 = "https://fjarcode.org"
VERSIONPREFIX = "fjarcode-core-"
...
def verify_published_handler(args: argparse.Namespace) -> ReturnCode:
    WORKINGDIR = Path(tempfile.gettempdir()) / f"fjarcode_verify_binaries.{args.version}"
    ...
    # remove binaries that are known not to be hosted by fjarcodecore.org
...
def main():
    ...
    pub_parser.add_argument(
        'version', type=str, help=(
            f'version of the fjarcode release to download; of the format '
    ...
    pub_parser.add_argument(
        ...
        help=(
            ...
            '(Sometimes fjarcode.org lags behind fjarcodecore.org.)')
    )
