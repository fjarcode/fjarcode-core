...
def parse_config_into_bc2_config():
    ...
    with open(os.path.join(SOURCE_DIR,'../build_msvc/fjarcode_config.h.in'), "r", encoding="utf8") as template_file:
    ...
    with open(os.path.join(SOURCE_DIR,'../build_msvc/fjarcode_config.h'), "w", encoding="utf8") as bc2_config:
        bc2_config.writelines(template)
...
def main():
    ...
    parse_config_into_bc2_config()
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/fjarcode_config.h'), os.path.join(SOURCE_DIR, 'config/fjarcode-config.h'))
