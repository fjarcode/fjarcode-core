...
#ifndef FJARCODE_KERNEL_DISCONNECTED_TRANSACTIONS_H
#define FJARCODE_KERNEL_DISCONNECTED_TRANSACTIONS_H
 ...
 *  Must be larger than FJARCODE_MAX_BLOCK_SIZE (32MB) to avoid losing transactions
 *  during reorgs of large blocks. */
static const unsigned int MAX_DISCONNECTED_TX_POOL_BYTES{40'000'000};
/**
...
#endif // FJARCODE_KERNEL_DISCONNECTED_TRANSACTIONS_H
