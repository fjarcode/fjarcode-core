...
#ifndef FJARCODE_CORE_IO_H
#define FJARCODE_CORE_IO_H
...
// The try_no_witness and try_witness parameters are retained for parsing historical
// transactions and blocks from before the fork.
