...
#ifndef FJARCODE_SEEDER_DB_H
#define FJARCODE_SEEDER_DB_H
...
public:
    ...
    void Serialize(Stream& s) const {
        // Serialize floats as uint32_t to work around FJAR not supporting float serialization
        uint32_t w, c, r;
        static_assert(sizeof(float) == sizeof(uint32_t));
...
public:
    ...
    Reliableness GetReliableness() const {
        // FJAR: allow non-standard ports since the seeder already validates
