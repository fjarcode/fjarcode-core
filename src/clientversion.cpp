 ...
 * for both fjarcoded and fjarcode-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("FJARCODE");
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/fjarcode/bips/blob/master/bip-0014.mediawiki)
 */
