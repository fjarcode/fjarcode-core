...
static void http_request_cb(struct evhttp_request* req, void* arg)
{
    ...
    // and https://github.com/fjarcode/fjarcode/pull/11593.
...
bool InitHTTPServer(const util::SignalInterrupt& interrupt)
{
    ...
    // FJAR: 32MB blocks hex-encoded = ~64MB + JSON overhead.
    // MAX_SIZE (33MB) is too small for submitblock with large blocks.
    evhttp_set_max_body_size(http, 2 * 32000000 + 4096); // 64MB + 4KB for JSON/RPC overhead
