...
#ifndef FJARCODE_INTERFACES_INIT_H
#define FJARCODE_INTERFACES_INIT_H
...
//! (fjarcode-gui, fjarcode-node, fjarcode-wallet, fjarcoded, fjarcode-qt) and each
...
#endif // FJARCODE_INTERFACES_INIT_H
