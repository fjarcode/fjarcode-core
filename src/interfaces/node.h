...
#ifndef FJARCODE_INTERFACES_NODE_H
#define FJARCODE_INTERFACES_NODE_H
...
//! Top-level interface for a fjarcode node (fjarcoded process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or fjarcode.conf.
...
#endif // FJARCODE_INTERFACES_NODE_H
