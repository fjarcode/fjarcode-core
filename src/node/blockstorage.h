...
#ifndef FJARCODE_NODE_BLOCKSTORAGE_H
#define FJARCODE_NODE_BLOCKSTORAGE_H
...
public:
    ...
    bool WriteFinalizedHeight(int nHeight);
    bool ReadFinalizedHeight(int& nHeight);
...
#endif // FJARCODE_NODE_BLOCKSTORAGE_H
