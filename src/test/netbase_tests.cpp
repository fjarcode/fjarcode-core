...
{
    BOOST_CHECK(TestSplitHost("www.fjarcodecore.org", "www.fjarcodecore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.fjarcodecore.org]", "www.fjarcodecore.org", 0));
    BOOST_CHECK(TestSplitHost("www.fjarcodecore.org:80", "www.fjarcodecore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.fjarcodecore.org]:80", "www.fjarcodecore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("::8338", "::8338", 0));
    BOOST_CHECK(TestSplitHost(":8338", "", 8338));
    BOOST_CHECK(TestSplitHost("[]:8338", "", 8338));
    ...
    BOOST_CHECK(TestSplitHost("www.fjarcodecore.org:65536", "www.fjarcodecore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.fjarcodecore.org:0", "www.fjarcodecore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.fjarcodecore.org:", "www.fjarcodecore.org:", 0, false));
}
