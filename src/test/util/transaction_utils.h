...
// After FJAR fork, new transactions have no witness data. These utilities
// are retained for testing historical transaction parsing and validation.

#ifndef FJARCODE_TEST_UTIL_TRANSACTION_UTILS_H
#define FJARCODE_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // FJARCODE_TEST_UTIL_TRANSACTION_UTILS_H
