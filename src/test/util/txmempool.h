...
#ifndef FJARCODE_TEST_UTIL_TXMEMPOOL_H
#define FJARCODE_TEST_UTIL_TXMEMPOOL_H
...
struct TestMemPoolEntryHelper {
    ...
    unsigned int sigOpCost{1}; // With WITNESS_SCALE_FACTOR=1 (FJAR), 1 legacy sigop = cost 1 (not 4)
    LockPoints lp;
...
#endif // FJARCODE_TEST_UTIL_TXMEMPOOL_H
