...
// IsWitnessProgram, etc.). These functions are still needed for parsing historical blocks that
// were created before the FJAR fork. After the fork, new SegWit transactions are not valid.
