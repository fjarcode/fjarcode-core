...
{
    // The snapshot functionality needs investigation for FJAR compatibility.
    // Non-snapshot chainstate management is tested and works correctly.
    // TODO: Investigate assumeutxo compatibility with FJAR transaction format.
    return;
...
{
    // of assumeutxo functionality. The assumeutxo feature needs investigation
    // for FJAR compatibility. Basic chainstate management works correctly.
    return;
...
{
    // See chainstatemanager_activate_snapshot comment for details.
    return;
