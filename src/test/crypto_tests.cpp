...
BOOST_AUTO_TEST_CASE(sha256_testvectors) {
    ...
    TestSHA256("As FJARCODE relies on 80 byte header hashes, we want to have an example for that.",
               "92d5feb6e81a4e20dd7143d6b8590688c0ff08bb344639d4cad8e4ed5e19fe02");
