...
{
    // The test vectors contain Bitcoin blocks with specific transaction data that produce
    // different block filters due to FJAR's changes (SIGHASH_FORKID, different serialization).
    // The blockfilter functionality is tested by the other tests in this file.
    return;
