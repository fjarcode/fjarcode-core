...
// After FJAR fork, witness data is not present, so wtxid will always equal txid.
// Tests are retained for historical compatibility and pre-fork transaction handling.
