...
// After FJAR fork, witness transactions are not valid, so witness sigop costs don't apply
// to new transactions. Tests are retained for historical block validation.
