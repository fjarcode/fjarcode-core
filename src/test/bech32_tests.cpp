...
// The codec is still needed for parsing historical addresses and for compatibility.
// After FJAR fork, bech32 addresses (SegWit) cannot be used for new transactions.
