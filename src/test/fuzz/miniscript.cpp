...
// features (P2WSH, Taproot). After FJAR fork, witness scripts cannot be created for new
// outputs. These tests are retained for historical compatibility and wallet migration.
