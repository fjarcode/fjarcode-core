...
// Witness signature version support is retained for validating historical pre-fork blocks.
// After FJAR fork, witness signatures cannot appear in new transactions.
