...
#ifndef FJARCODE_CONSENSUS_CONSENSUS_H
#define FJARCODE_CONSENSUS_CONSENSUS_H
...
inline constexpr uint64_t MAX_CONSENSUS_BLOCK_SIZE = 2'000'000'000;
...
#endif // FJARCODE_CONSENSUS_CONSENSUS_H
