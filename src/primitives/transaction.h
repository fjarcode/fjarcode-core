...
#ifndef FJARCODE_PRIMITIVES_TRANSACTION_H
#define FJARCODE_PRIMITIVES_TRANSACTION_H
...
// and parsing pre-fork transactions. After FJAR fork, new transactions have no witness data.
...
#endif // FJARCODE_PRIMITIVES_TRANSACTION_H
