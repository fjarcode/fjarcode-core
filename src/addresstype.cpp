...
// are retained for parsing and spending pre-fork UTXOs. After FJAR fork, new witness
// addresses cannot be created but existing witness destinations must still be handled.
