...
#ifndef FJARCODE_QT_FJARCODEGUI_H
#define FJARCODE_QT_FJARCODEGUI_H
...
/**
  Fjarcode GUI main class. This class represents the main window of the Fjarcode UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class FjarcodeGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit FjarcodeGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~FjarcodeGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a fjarcode wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, FjarcodeUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Fjarcode Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(FjarcodeUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

using FJARCODEGUI = FjarcodeGUI;

#endif // FJARCODE_QT_FJARCODEGUI_H
