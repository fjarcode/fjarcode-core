...
#ifndef FJARCODE_QT_OPTIONSMODEL_H
#define FJARCODE_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for FJARCODE client.
...
public:
    ...
    FJARCODEUnit getDisplayUnit() const { return m_display_fjarcode_unit; }
...
private:
    ...
    QString language;
    FJARCODEUnit m_display_fjarcode_unit;
...
Q_SIGNALS:
    void displayUnitChanged(FJARCODEUnit unit);
...
#endif // FJARCODE_QT_OPTIONSMODEL_H
