...
{
    switch (unit) {
    case Unit::BTC: return QString("FJAR");
    case Unit::mBTC: return QString("mFJAR");
    case Unit::uBTC: return QString::fromUtf8("µFJAR (bits)");
...
QString BitcoinUnits::description(Unit unit)
{
    switch (unit) {
    case Unit::BTC: return QString("FJAR");
    case Unit::mBTC: return QString("Milli-FJAR (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-FJAR (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
