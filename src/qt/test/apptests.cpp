...
//! Entry point for FJARCODEApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &FJARCODEApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for FJARCODEGUI tests.
void AppTests::guiTests(FJARCODEGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &FJARCODEGUI::consoleShown, this, &AppTests::consoleTests);
