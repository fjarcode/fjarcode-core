...
{
    // Test regression https://github.com/fjarcode/fjarcode/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/fjarcode-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/fjarcode-core/gui/pull/568.
    // With fListen=false in ~/.config/fjarcode/fjarcode-qt.conf and all else left as default,
    // fjarcode-qt should set both -listen and -listenonion to false and start successfully.
