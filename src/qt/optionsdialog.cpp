      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->fjarcodeAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->fjarcodeAtStartup);
    ...
    ui->fjarcodeAtStartup->setToolTip(ui->fjarcodeAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->fjarcodeAtStartup->setText(ui->fjarcodeAtStartup->text().arg(PACKAGE_NAME));

    ui->openFJARCODEConfButton->setToolTip(ui->openFJARCODEConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new FJARCODEUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->fjarcodeAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openFJARCODEConfButton_clicked()
{
