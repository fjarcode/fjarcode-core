    ...
    m_current_height(chain_start->nHeight)
{
    ...
    // 10,000 commitments × 48 bytes = ~480KB per peer
    static constexpr uint64_t MAX_COMMITMENTS_CAP = 10000;
    if (m_max_commitments > MAX_COMMITMENTS_CAP) {
        m_max_commitments = MAX_COMMITMENTS_CAP;
    }
