...
#ifndef FJARCODE_PROTOCOL_H
#define FJARCODE_PROTOCOL_H
...
/**
 * Double-spend proof message.
 * Contains proof that two conflicting transactions exist.
 */
...
enum ServiceFlags : uint64_t {
    ...
    // witness data.
    // This flag is retained for historical block validation and signet compatibility.
    NODE_WITNESS = (1 << 3),
    ...
    // fjarcode-development mailing list. Remember that service bits are just
 ...
 *
 * This prevents fingerprinting FJAR nodes as "claiming witness support
 * but not actually using it."
 */
constexpr ServiceFlags SeedsServiceFlags() { return ServiceFlags(NODE_NETWORK); }
...
enum GetDataMsg : uint32_t {
    ...
    MSG_TX = 1,
    MSG_BLOCK = 2,
    MSG_WTX = 5,                                      //!< Defined in BIP 339. FJAR: After fork, wtxid equals txid.
    ...
    MSG_DOUBLESPENDPROOF = 0x94a0,                    //!< FJAR: Double-spend proof (from BCHN)
};
...
public:
    ...
    bool IsMsgDSProof() const { return type == MSG_DOUBLESPENDPROOF; }
