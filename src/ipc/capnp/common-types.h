...
#ifndef FJARCODE_IPC_CAPNP_COMMON_TYPES_H
#define FJARCODE_IPC_CAPNP_COMMON_TYPES_H
...
//! Functions to serialize / deserialize common fjarcode types.
namespace mp {
...
#endif // FJARCODE_IPC_CAPNP_COMMON_TYPES_H
