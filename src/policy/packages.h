...
#ifndef FJARCODE_POLICY_PACKAGES_H
#define FJARCODE_POLICY_PACKAGES_H
...
static constexpr uint32_t MAX_PACKAGE_WEIGHT = 101'000;
...
// weight equals vsize (WITNESS_SCALE_FACTOR=1, no SegWit).
...
#endif // FJARCODE_POLICY_PACKAGES_H
