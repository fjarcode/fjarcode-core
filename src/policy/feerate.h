...
#ifndef FJARCODE_POLICY_FEERATE_H
#define FJARCODE_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "FJAR"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    CDF_KVB,      //!< Use FJAR/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::CDF_KVB) const;
...
#endif // FJARCODE_POLICY_FEERATE_H
