...
CAmount GetDustThreshold(const CTxOut& txout, const CFeeRate& dustRelayFeeIn)
{
    ...
    // 546 satooshis at the default rate of 3000 sat/kvB.
    // A typical spendable segwit P2WPKH txout is 31 bytes big, and will
    // need a CTxIn of at least 67 bytes to spend:
    // so dust is a spendable txout less than
    // 98*dustRelayFee/1000 (in satooshis).
    // 294 satooshis at the default rate of 3000 sat/kvB.
    ...
    // See discussion in https://github.com/fjarcode/fjarcode/pull/22779 for details.
