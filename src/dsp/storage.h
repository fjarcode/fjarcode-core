...
#ifndef FJARCODE_DSP_STORAGE_H
#define FJARCODE_DSP_STORAGE_H
...
public:
    ...
    /// Returns the number of proofs currently stored that are marked as orphans
    ...
    /// Each item is a pair of a uint256 and the nodeId that sent the proof to us.
