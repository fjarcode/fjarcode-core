...
#ifndef FJARCODE_DSP_DSPID_H
#define FJARCODE_DSP_DSPID_H
...
//!   exist.
//! - Unlike unique_ptr, comparison operators always do a deep-compare of the
//!   pointed-to DspId, with nullptr being semantically equivalent to an IsNull()
...
public:
    ...
    //! Convenience: Support copy-assignment from the underlying type directly
