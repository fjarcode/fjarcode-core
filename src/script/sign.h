...
#ifndef FJARCODE_SCRIPT_SIGN_H
#define FJARCODE_SCRIPT_SIGN_H
...
/** FJAR: Produce a script signature for post-fork spending of witness outputs.
 *  When fjarcode_witness_via_scriptsig is true, witness program outputs (P2WPKH, P2WSH, P2TR)
 *  are signed with data in scriptSig instead of the witness field.
 */
bool ProduceSignature(const SigningProvider& provider, const BaseSignatureCreator& creator, const CScript& scriptPubKey, SignatureData& sigdata, bool fjarcode_witness_via_scriptsig);
