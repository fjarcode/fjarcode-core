...
// After FJAR fork activation, witness scripts cannot be used for new outputs.
// Witness-related miniscript functionality is retained for:
// - Spending historical witness UTXOs
// - Wallet migration and compatibility
// - Descriptor parsing for pre-fork transactions

#ifndef FJARCODE_SCRIPT_MINISCRIPT_H
#define FJARCODE_SCRIPT_MINISCRIPT_H
...
//! Parse a miniscript from a fjarcode script
...
#endif // FJARCODE_SCRIPT_MINISCRIPT_H
