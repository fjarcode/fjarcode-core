...
// TaprootBuilder, etc.). After FJAR fork, witness scripts cannot be created for
// new outputs. These types are retained for spending historical UTXOs and
// wallet backward compatibility.

#ifndef FJARCODE_SCRIPT_SIGNINGPROVIDER_H
#define FJARCODE_SCRIPT_SIGNINGPROVIDER_H
...
#endif // FJARCODE_SCRIPT_SIGNINGPROVIDER_H
