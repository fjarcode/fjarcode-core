...
std::string GetOpName(opcodetype opcode)
{
    ...
    // Note: In BTC Tapscript this is OP_CHECKSIGADD, but FJAR disables Tapscript
...
// and blocks from before the FJAR fork. New witness outputs cannot be created after fork.
