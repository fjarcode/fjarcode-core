...
#ifndef FJARCODE_SCRIPT_VM_LIMITS_H
#define FJARCODE_SCRIPT_VM_LIMITS_H
#include <cassert>
#include <cstdint>
...
// Note: MAX_PUBKEYS_PER_MULTISIG, MAX_SCRIPT_SIZE, MAX_STACK_SIZE, LOCKTIME_THRESHOLD
// are defined in script/script.h and not duplicated here.


// The below constants are used after activation of the May 2025 upgrade (Targeted VM Limits CHIP)
namespace may2025 {

// Maximum number of bytes pushable to the stack (equals MAX_SCRIPT_SIZE from script.h)
...
#endif // FJARCODE_SCRIPT_VM_LIMITS_H
