...
#ifndef FJARCODE_SCRIPT_SIGCACHE_H
#define FJARCODE_SCRIPT_SIGCACHE_H
...
public:
    ...
    CachingTransactionSignatureChecker(const CTransaction* txToIn, unsigned int nInIn, const CAmount& amountIn, bool storeIn, PrecomputedTransactionData& txdataIn, const ScriptExecutionContext* context) : TransactionSignatureChecker(txToIn, nInIn, amountIn, txdataIn, MissingDataBehavior::ASSERT_FAIL, context), store(storeIn) {}
...
#endif // FJARCODE_SCRIPT_SIGCACHE_H
