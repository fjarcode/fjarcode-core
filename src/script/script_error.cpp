...
std::string ScriptErrorString(const ScriptError serror)
{
    switch (serror)
    {
        ...
        case SCRIPT_ERR_SEGWIT_NOT_ALLOWED:
            return "SegWit not allowed after FJAR fork";
        case SCRIPT_ERR_MISSING_FORKID:
            return "SIGHASH_FORKID required after FJAR fork";
        case SCRIPT_ERR_INVALID_OPERAND_SIZE:
            return "Operands must be the same size";
        case SCRIPT_ERR_INVALID_SPLIT_RANGE:
            return "Split position out of range";
        case SCRIPT_ERR_DIV_BY_ZERO:
            return "Division by zero";
        case SCRIPT_ERR_MOD_BY_ZERO:
            return "Modulo by zero";
        case SCRIPT_ERR_IMPOSSIBLE_ENCODING:
            return "Cannot encode number in requested size";
        case SCRIPT_ERR_INVALID_NUMBER_RANGE:
            return "Number out of valid range";
        case SCRIPT_ERR_CONTEXT_NOT_PRESENT:
            return "Script execution context not available for introspection";
        case SCRIPT_ERR_INVALID_BITFIELD_SIZE:
            return "Invalid bitfield size";
        case SCRIPT_ERR_INVALID_BIT_RANGE:
            return "Invalid bit range";
        case SCRIPT_ERR_OP_COST:
            return "Operation cost limit exceeded";
        case SCRIPT_ERR_HASH_ITERS:
