...
#ifndef FJARCODE_SCRIPT_SCRIPTCACHE_H
#define FJARCODE_SCRIPT_SCRIPTCACHE_H
...
public:
    ...
    ScriptCacheKey &operator=(const ScriptCacheKey &) noexcept = default;
...
#endif // FJARCODE_SCRIPT_SCRIPTCACHE_H
