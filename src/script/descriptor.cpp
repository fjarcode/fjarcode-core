...
// compatibility with pre-fork blocks, PSBT migration, and spending existing witness UTXOs.
// After FJAR fork activation, witness descriptors cannot be used to create new outputs.
// Only pkh() and sh() descriptors are valid for new transactions after the fork.
...
public:
     ...
     * @return The maximum size of the satisfaction in raw bytes.
     */
