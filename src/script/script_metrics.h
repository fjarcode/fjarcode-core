...
#ifndef FJARCODE_SCRIPT_SCRIPT_METRICS_H
#define FJARCODE_SCRIPT_SCRIPT_METRICS_H
...
class ScriptExecutionMetrics {
    ...
    // Bit 29 = SCRIPT_VM_LIMITS_STANDARD (defined in interpreter.h and script_flags.h)
    static bool IsVmLimitsStandard(uint32_t scriptFlags) { return scriptFlags & (1U << 29); }
...
#endif // FJARCODE_SCRIPT_SCRIPT_METRICS_H
