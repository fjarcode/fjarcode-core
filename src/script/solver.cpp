...
// is retained for parsing pre-fork outputs. After FJAR fork, witness outputs
// cannot be newly created but existing ones must still be recognized for spending.
