...
enum
{
    ...
    fjarcodeconsensus_SCRIPT_FLAGS_VERIFY_P2SH                = (1U << 0),
    fjarcodeconsensus_SCRIPT_FLAGS_VERIFY_DERSIG              = (1U << 2),
    fjarcodeconsensus_SCRIPT_FLAGS_VERIFY_NULLDUMMY           = (1U << 4),
    fjarcodeconsensus_SCRIPT_FLAGS_VERIFY_CHECKLOCKTIMEVERIFY = (1U << 9),
    fjarcodeconsensus_SCRIPT_FLAGS_VERIFY_CHECKSEQUENCEVERIFY = (1U << 10),
    fjarcodeconsensus_SCRIPT_FLAGS_VERIFY_WITNESS             = (1U << 11),
    fjarcodeconsensus_SCRIPT_FLAGS_VERIFY_TAPROOT             = (1U << 17),
    fjarcodeconsensus_SCRIPT_FLAGS_VERIFY_ALL                 =
        fjarcodeconsensus_SCRIPT_FLAGS_VERIFY_P2SH |
        fjarcodeconsensus_SCRIPT_FLAGS_VERIFY_DERSIG |
        fjarcodeconsensus_SCRIPT_FLAGS_VERIFY_NULLDUMMY |
        fjarcodeconsensus_SCRIPT_FLAGS_VERIFY_CHECKLOCKTIMEVERIFY |
        fjarcodeconsensus_SCRIPT_FLAGS_VERIFY_CHECKSEQUENCEVERIFY |
