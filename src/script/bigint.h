...
// NOTE: This file is currently DEAD CODE in the FJAR build.
// BigInt support (CHIP-2024-07) is handled via increased CScriptNum limits
// when VM Limits are active, not through this standalone BigInt class.
// This file is not compiled into any binary and is not referenced by the
// script interpreter. It is retained for potential future use.

#ifndef FJARCODE_SCRIPT_BIGINT_H
#define FJARCODE_SCRIPT_BIGINT_H
...
#endif // FJARCODE_SCRIPT_BIGINT_H
