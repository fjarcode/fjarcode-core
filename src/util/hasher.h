...
#ifndef FJARCODE_UTIL_HASHER_H
#define FJARCODE_UTIL_HASHER_H
...
/**
 * SaltedUint256Hasher - Generic uint256 hasher with random salt.
 * Used by DSProof storage for DspId hashing.
 */
