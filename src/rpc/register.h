...
#ifndef FJARCODE_RPC_REGISTER_H
#define FJARCODE_RPC_REGISTER_H
...
void RegisterDSProofRPCCommands(CRPCTable&);
void RegisterABCRPCCommands(CRPCTable&);
