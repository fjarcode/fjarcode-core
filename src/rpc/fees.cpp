...
static RPCHelpMan estimatesmartfee()
{
    return RPCHelpMan{"estimatesmartfee",
        ...
        "in BIP 141 (witness data is discounted). Note: After FJAR fork, witness data is not present in transactions.\n",
        {
...
static RPCHelpMan estimaterawfee()
{
    return RPCHelpMan{"estimaterawfee",
        ...
        "defined in BIP 141 (witness data is discounted). Note: After FJAR fork, witness data is not present in transactions.\n",
        {
            {"conf_target", RPCArg::Type::NUM, RPCArg::Optional::NO, "Confirmation target in blocks (1 - 1008)"},
