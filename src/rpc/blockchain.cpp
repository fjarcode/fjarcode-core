...
static RPCHelpMan getblockstats()
{
    return RPCHelpMan{"getblockstats",
            ...
            RPCResult::Type::OBJ, "", "",
            {
                ...
                {RPCResult::Type::NUM, "swtotal_size", /*optional=*/true, "Total size of all segwit transactions (always 0 after FJAR fork)"},
                {RPCResult::Type::NUM, "swtotal_weight", /*optional=*/true, "Total weight of all segwit transactions (always 0 after FJAR fork)"},
                {RPCResult::Type::NUM, "swtxs", /*optional=*/true, "The number of segwit transactions (always 0 after FJAR fork)"},
...
static RPCHelpMan scanblocks()
{
    return RPCHelpMan{"scanblocks",
        ...
        "This call may take several minutes. Make sure to use no RPC timeout (fjarcode-cli -rpcclienttimeout=0)",
        {
            scan_action_arg_desc,
            scan_objects_arg_desc,
    ...
    const fs::path& temppath)
{
...

    {
        ...
        //
        // See discussion here:
        //   https://github.com/fjarcode/fjarcode/pull/15606#discussion_r274479369
        //
        LOCK(::cs_main);
...
static RPCHelpMan loadtxoutset()
{
    return RPCHelpMan{
        ...
        "The result is a usable fjarcoded instance that is current with the network tip in a "
        ...
        "document (<https://github.com/fjarcode/fjarcode/blob/master/doc/design/assumeutxo.md>).",
        {
            {"path",
                RPCArg::Type::STR,
                RPCArg::Optional::NO,
...
// =========================================================================
// FJAR/BCHN Automatic Finalization RPC Commands
// =========================================================================
...
static RPCHelpMan parkblock()
{
    return RPCHelpMan{"parkblock",
                ...
                "This is used by FJAR's automatic finalization system to reject deep reorgs.\n",
                {
...
// =========================================================================
// End FJAR/BCHN Automatic Finalization RPC Commands
// =========================================================================
