...
#ifndef FJARCODE_RPC_UTIL_H
#define FJARCODE_RPC_UTIL_H
...
/**
 * Parse a json number or string, denoting FJAR/kvB, into a CFeeRate (sat/kvB).
 * Reject negative values or rates larger than 1FJARCODE/kvB.
 */
