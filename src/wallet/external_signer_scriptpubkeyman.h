...
#ifndef FJARCODE_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define FJARCODE_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // FJARCODE_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
