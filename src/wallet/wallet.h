...
#ifndef FJARCODE_WALLET_WALLET_H
#define FJARCODE_WALLET_WALLET_H
...
//! -fallbackfee default (FJAR: Match BCHN - 20 sat/byte)
...
//! -walletrbf default (FJAR: RBF disabled, no opt-in RBF support)
...
// With WITNESS_SCALE_FACTOR=1 (FJAR), no witness discount: P2SH-P2WPKH input vsize = 172
...
public:
     ...
     * fjarcode-wallet tool code or by wallet migration code. If this is called
     ...
     *  Callers should check for -1 if they need to handle uninitialized state. */
...
#endif // FJARCODE_WALLET_WALLET_H
