...
RPCHelpMan getnewaddress()
{
    return RPCHelpMan{"getnewaddress",
                ...
                "so payments received with the address will be associated with 'label'.\n",
                {
                    ...
                    {"address_type", RPCArg::Type::STR, RPCArg::DefaultHint{"set by -addresstype"}, "The address type to use. Only \"legacy\" is supported after FJAR fork (SegWit is disabled)."},
                },
                RPCResult{
                    RPCResult::Type::STR, "address", "The new FJAR address"
                },
                RPCExamples{
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    if (consensusParams.IsFJARCODEActive(nHeight)) {
        if (output_type != OutputType::LEGACY) {
            throw JSONRPCError(RPC_INVALID_PARAMETER, "Only legacy addresses are allowed after FJAR fork (SegWit is disabled)");
        }
    }
...
RPCHelpMan getrawchangeaddress()
{
    return RPCHelpMan{"getrawchangeaddress",
                ...
                {
                    {"address_type", RPCArg::Type::STR, RPCArg::DefaultHint{"set by -changetype"}, "The address type to use. Only \"legacy\" is supported after FJAR fork (SegWit is disabled)."},
                },
                RPCResult{
...
RPCHelpMan setlabel()
{
    return RPCHelpMan{"setlabel",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The FJAR address to be associated with a label."},
                ...
                RPCResult{
                    RPCResult::Type::ARR, "", "",
                    {
                        {RPCResult::Type::ARR, "", "",
                        {
                            ...
                            {
                                {RPCResult::Type::STR, "address", "The FJAR address"},
...
RPCHelpMan addmultisigaddress()
{
    return RPCHelpMan{"addmultisigaddress",
                ...
                "Note: This command is only compatible with legacy wallets.\n",
                {
                    ...
                    {"keys", RPCArg::Type::ARR, RPCArg::Optional::NO, "The FJAR addresses or hex-encoded public keys",
                        {
                            {"key", RPCArg::Type::STR, RPCArg::Optional::OMITTED, "FJAR address or hex-encoded public key"},
                        },
                        },
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    // FJAR: Only legacy (P2SH) multisig addresses are valid post-fork
    if (Params().GetConsensus().IsFJARCODEActive(pwallet->GetLastBlockHeight())) {
        if (output_type != OutputType::LEGACY) {
            throw JSONRPCError(RPC_INVALID_PARAMETER,
                "Only legacy multisig addresses are allowed after FJAR fork (SegWit is disabled)");
        }
    }
...
RPCHelpMan getaddressinfo()
{
    return RPCHelpMan{"getaddressinfo",
                "\nReturn information about the given FJAR address.\n"
                "Some of the information will only be present if the address is in the active wallet.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The FJAR address for which to get information."},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        {RPCResult::Type::STR, "address", "The FJAR address validated."},
                        ...
                        {RPCResult::Type::BOOL, "iswitness", "If the address is a witness address (always false for new addresses after FJAR fork)."},
                        {RPCResult::Type::NUM, "witness_version", /*optional=*/true, "The version number of the witness program (not used after FJAR fork)."},
                        {RPCResult::Type::STR_HEX, "witness_program", /*optional=*/true, "The hex value of the witness program (not used after FJAR fork)."},
...
RPCHelpMan walletdisplayaddress()
{
    return RPCHelpMan{
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "FJAR address to display"},
        },
        RPCResult{
            RPCResult::Type::OBJ,"","",
            {
