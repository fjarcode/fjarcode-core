...
{
    argsman.AddArg("-addresstype", strprintf("What type of addresses to use (default: \"%s\"). Only \"legacy\" is supported after FJAR fork.", FormatOutputType(DEFAULT_ADDRESS_TYPE)), ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);
    ...
    argsman.AddArg("-changetype",
                   "What type of change to use (default: \"legacy\"). Only \"legacy\" is supported after FJAR fork.",
