...
#ifndef FJARCODE_WALLET_TRANSACTION_H
#define FJARCODE_WALLET_TRANSACTION_H
...
public:
     ...
     * on this fjarcode node, and set to 0 for transactions that were created
...
#endif // FJARCODE_WALLET_TRANSACTION_H
