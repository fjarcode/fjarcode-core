...
bool LoadWallets(WalletContext& context)
{
    ...
    try {
        ...
        LogPrintf("FJAR MIGRATION WARNING: Taproot script-path (P2TR with scripts) UTXOs are NOT supported for migration.\n");
        LogPrintf("FJAR MIGRATION WARNING: Only Taproot key-path spending is supported after the FJAR fork.\n");
        LogPrintf("FJAR MIGRATION WARNING: If you have Taproot script-path UTXOs, move them BEFORE the FJAR fork activates.\n");
