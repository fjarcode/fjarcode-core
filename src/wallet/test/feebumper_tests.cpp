...
// After FJAR fork, witness data is not present in new transactions.
// With WITNESS_SCALE_FACTOR=1, weight equals size (no witness discount).
// These tests are retained for spending historical witness UTXOs.
...
{
    // P2PKH (weight = input_size + empty_witness = 148 + 1 = 149)
