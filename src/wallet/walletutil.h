...
#ifndef FJARCODE_WALLET_WALLETUTIL_H
#define FJARCODE_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! fjarcode from opening the wallet, thinking it was newly created, and
...
#endif // FJARCODE_WALLET_WALLETUTIL_H
