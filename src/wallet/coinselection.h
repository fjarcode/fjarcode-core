...
#ifndef FJARCODE_WALLET_COINSELECTION_H
#define FJARCODE_WALLET_COINSELECTION_H
...
public:
     ...
     *  + non-input fees always include segwit flags (FJAR: not applicable after fork - no witness data)
     *  + input fee estimation always include segwit stack size (FJAR: not applicable after fork)
...
#endif // FJARCODE_WALLET_COINSELECTION_H
