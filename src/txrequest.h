...
#ifndef FJARCODE_TXREQUEST_H
#define FJARCODE_TXREQUEST_H
 ...
 *
 * is not present in new transactions. The wtxid/txid distinction is retained for
 * historical compatibility and signet operation.
 *
