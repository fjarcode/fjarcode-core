...
#ifndef FJARCODE_PSBT_H
#define FJARCODE_PSBT_H
...
// Taproot fields) are retained for PSBT compatibility and spending pre-fork UTXOs.
// After FJAR fork, new transactions will not populate witness fields.
struct PSBTInput
{
 ...
 * @param[in] sighash_type The sighash type to use for finalization (default SIGHASH_ALL)
 * return True if the PSBT is now complete, false otherwise
 */
bool FinalizePSBT(PartiallySignedTransaction& psbtx, int sighash_type = 1 /*SIGHASH_ALL*/);
 ...
 */
bool FinalizeAndExtractPSBT(PartiallySignedTransaction& psbtx, CMutableTransaction& result, int sighash_type = 1 /*SIGHASH_ALL*/);
