...
#ifndef FJARCODE_ADDRESSTYPE_H
#define FJARCODE_ADDRESSTYPE_H
 ...
 *  A CTxDestination is the internal data type encoded in a FJAR address
 */
...
/** FJAR: Check whether a CTxDestination is a witness (SegWit) destination.
 *  Returns true for P2WPKH, P2WSH, P2TR, and unknown witness versions. */
