...
#ifndef FJARCODE_BLOCKENCODINGS_H
#define FJARCODE_BLOCKENCODINGS_H
...
public:
    ...
    uint256 blockhash;
    std::vector<uint32_t> indexes; // FJAR: widened from uint16_t for 32MB blocks (>65535 txs)
...
struct PrefilledTransaction {
    ...
    uint32_t index; // FJAR: widened from uint16_t for 32MB blocks (>65535 txs)
    CTransactionRef tx;
...
#endif // FJARCODE_BLOCKENCODINGS_H
