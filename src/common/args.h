...
#ifndef FJARCODE_COMMON_ARGS_H
#define FJARCODE_COMMON_ARGS_H
...
extern const char * const FJARCODE_CONF_FILENAME;
extern const char * const FJARCODE_SETTINGS_FILENAME;
