...
The interface runs on the same port as the JSON-RPC interface, by default port 28442 for mainnet, port 29442 for testnet,
port 30442 for signet, and port 31442 for regtest.
...
Example:
```
$ curl localhost:29442/rest/getutxos/checkmempool/b2cdfd7b89def827ff8af7cd9bff7627ff72e5e8b0f71210f92ea7a4000c5d75-0.json 2>/dev/null | json_pp
{
   "chainHeight" : 325347,
...
Risks
-------------
Running a web browser on the same node with a REST enabled fjarcoded can be a risk. Accessing prepared XSS websites could read out tx/block data of your node by placing links like `<script src="http://127.0.0.1:28442/rest/tx/1234567890.json">` which might break the nodes privacy.
