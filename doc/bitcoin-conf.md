...
-- | -- | --
Windows | `%LOCALAPPDATA%\FJARCODE\` | `C:\Users\username\AppData\Local\FJARCODE\fjarcode.conf`
Linux | `$HOME/.fjarcode/` | `/home/username/.fjarcode/fjarcode.conf`
macOS | `$HOME/Library/Application Support/FJARCODE/` | `/Users/username/Library/Application Support/FJARCODE/fjarcode.conf`
...
cp share/examples/bitcoin.conf ~/.fjarcode/fjarcode.conf
```
