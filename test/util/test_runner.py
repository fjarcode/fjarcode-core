...
"""Test framework for fjarcode utils.
...
def main():
    ...
    bctester(os.path.join(env_conf["SRCDIR"], "test", "util", "data"), "fjarcode-util-test.json", env_conf)
...
def bctest(testDir, testObj, buildenv):
    ...
    if testObj["exec"] == "./fjarcode-util":
        execprog = os.getenv("FJARCODEUTIL", default=execprog)
    elif testObj["exec"] == "./fjarcode-tx":
        execprog = os.getenv("FJARCODETX", default=execprog)
    ...
    if "error_txt" in testObj:
        ...
        # That stderr is empty if no errors are expected. However, fjarcode-tx
