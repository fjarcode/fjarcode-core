...
class MempoolCoinbaseTest(BitcoinTestFramework):
    ...
    def test_reorg_relay(self):
        ...
        requests_too_recent = msg_getdata([CInv(t=MSG_TX, h=int(tx["tx"].getwtxid(), 16)) for tx in [tx_before_reorg, tx_child]])
        ...
        request_disconnected_tx = msg_getdata([CInv(t=MSG_TX, h=int(tx_disconnected["tx"].getwtxid(), 16))])
        ...
        request_after_reorg = msg_getdata([CInv(t=MSG_TX, h=int(tx_after_reorg["tx"].getwtxid(), 16))])
