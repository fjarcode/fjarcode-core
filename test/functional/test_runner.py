...
BASE_SCRIPTS = [
    ...
    'rpc_address_encoding_contract.py',
    'rpc_code_quantum_address.py',
    'rpc_code_quantum_address_schema_contract.py',
    'rpc_code_quantum_help_contract.py',
    'rpc_code_quantum_info_help_contract.py',
    'rpc_code_quantum_info.py',
    'rpc_code_quantum_interop_reference_harness.py',
    'rpc_code_quantum_info_schema_contract.py',
    'rpc_code_quantum_mldsa_native_vectors.py',
    'rpc_code_quantum_regtest_activation_harness.py',
    'rpc_code_quantum_runtime_contract.py',
    'rpc_code_quantum_testnet4_chainstart_vectors.py',
    'rpc_code_quantum_policy_anchor_contract.py',
    'rpc_code_quantum_test_inventory_contract.py',
    'rpc_getnewquantumaddress.py',
    'rpc_getnewaddress_quantum_help_contract.py',
    'rpc_getnewquantumaddress_help_contract.py',
    'rpc_policy_parity_contract.py',
    ...
    'wallet_code_quantum_signing.py',
    'wallet_reindex.py',
