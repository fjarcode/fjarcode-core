...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 FJAR from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 FJAR in block rewards plus fees, but
        ...
        # Send 10 FJAR with subtract fee from amount
        ...
        # Sendmany 10 FJAR with subtract fee from amount
        ...
        # Sendmany 5 FJAR to two addresses with subtracting fee from both addresses
        ...
        fee_rate_sat_vb = 2
        fee_rate_bc2_kvb = fee_rate_sat_vb * 1e3 / 1e8
        ...
        if not self.options.descriptors:
            ...
            # FJAR: p2sh-segwit produces a P2PKH address, so the error is -4 (key not found)
            # instead of -3 (address does not refer to a key)
            ...
            assert_fee_amount(fee, tx_size, Decimal(fee_rate_bc2_kvb))
        ...
        assert_equal(address_info['address'], "fjarcode:qp8rs4qyd3aazk22eyzwg7fmdfzmxm02pyz686sg9p")
