...
class ReplaceByFeeTest(BitcoinTestFramework):
    ...
    def test_doublespend_chain(self):
        ...
        # child fees - 4 FJAR - so this attempt is rejected.
    ...
    def test_too_many_replacements(self):
        ...
        double_tx.vin.pop()
        if hasattr(double_tx, '_fjarcode_input_amounts') and double_tx._fjarcode_input_amounts:
            double_tx._fjarcode_input_amounts.pop()
        self.wallet.sign_tx(double_tx)
        double_tx_hex = double_tx.serialize().hex()
