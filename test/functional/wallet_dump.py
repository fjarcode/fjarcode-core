...
def read_dump(file_name, addrs, script_addrs, hd_master_addr_old):
    ...
    with open(file_name, encoding='utf8') as inputfile:
            ...
            if line[0] == '#':
                ...
                for addrObj in addrs:
                    if addrObj['address'] == addr.split(",")[0] and addrObj['hdkeypath'] == keypath and keytype == "label=":
                        # FJAR: All addresses are CashAddr P2PKH (fjarcode:qq...)
                        if addr.startswith('fjarcode:q'):
                            found_legacy_addr += 1
                        break
        ...
        return found_comments, found_legacy_addr, found_script_addr, found_addr_chg, found_addr_rsv, hd_master_addr_ret
...
class WalletDumpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # generate 10 P2PKH addresses to compare against the dump
        # FJAR only supports P2PKH (CashAddr format)
        test_addr_count = 10
        addrs = []
        ...
        found_comments, found_legacy_addr, found_script_addr, found_addr_chg, found_addr_rsv, hd_master_addr_unenc = \
        ...
        assert_equal(found_legacy_addr, test_addr_count)  # all P2PKH keys must be in the dump
        ...
        with WalletUnlock(self.nodes[0], "test"):
            ...
            found_comments, found_legacy_addr, found_script_addr, found_addr_chg, found_addr_rsv, _ = \
        ...
        # See https://github.com/fjarcode/fjarcode/issues/22489
