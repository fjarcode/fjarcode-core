...
class FullBlockTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure fjarcoded isn't accepting b26
        ...
        # Extend the b28 chain to make sure fjarcoded isn't accepting b28
        ...
        # fjarcoded doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #
        # b69 - coinbase with extra 10 satooshis, and a tx that gives a 10 satoshi fee
        #       this succeeds
        #
        ...
        #    Low-S and High-S values (whereas the fjarcode code has custom code which does so);
