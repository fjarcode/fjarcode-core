...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 40 FJAR from 0 to 1 and 60 FJAR from 1 to 0.
        ...
        # FJAR, which is more than would be available if transaction 1 were
        # replaced.
        ...
        if not self.options.descriptors:
            ...
            # In FJAR, importprivkey removes all watch-only scripts for that key,
            # so the 'watchonly' section disappears entirely from getbalances().
