...
class ImportWithLabel(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # FJAR: Skipping p2sh-segwit label test - SegWit addresses do not exist in FJAR.
        # The original test imported a p2sh-segwit address and checked the 'embedded' field,
        # which is not present for P2PKH addresses.
