...
class SignMessagesWithPrivTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(addresses[0], 'fjarcode:qpst4g85jjecec7fgr02vlecqnw9950mjsmxr0td2e')
        ...
        assert_raises_rpc_error(-3, "Malformed base64 encoding", self.nodes[0].verifymessage, 'fjarcode:qpst4g85jjecec7fgr02vlecqnw9950mjsmxr0td2e', "invalid_sig", message)
