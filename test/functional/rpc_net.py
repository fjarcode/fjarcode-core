...
class NetTest(BitcoinTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=8338)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 8338)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=8338), {"success": False})
    ...
    def test_sendmsgtopeer(self):
        ...
        # FJAR: MAX_PROTOCOL_MESSAGE_LENGTH is 33MB, so sending >33MB via RPC
        # is impractical. Oversized message handling is tested in p2p_invalid_messages.py instead.
        self.log.debug("Skipping oversized message test (FJAR: 33MB limit tested in p2p_invalid_messages)")
