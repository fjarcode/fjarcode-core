...
class WalletGroupTest(BitcoinTestFramework):
    ...
    def set_test_params(self):
        ...
        for args in self.extra_args:
            ...
            args.append(f"-paytxfee={20 * 1e3 / 1e8}")  # apply feerate of 20 sat2s/vB across all nodes
    ...
    def run_test(self):
        ...
        # Sending 1.4 FJAR should pick one 1.0 + one more. For node #1,
        ...
        tx4_ungrouped_fee = 4500
        tx4_grouped_fee = 7440
        tx5_6_ungrouped_fee = 10380
        tx5_6_grouped_fee = 16260
