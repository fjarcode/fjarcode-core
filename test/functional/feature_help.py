...
"""Verify that starting fjarcode with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start fjarcode with -h for help text")
        ...
        self.log.info("Start fjarcode with -version for version information")
        ...
        self.log.info("Start fjarcoded with -fakearg to make sure it does not start")
