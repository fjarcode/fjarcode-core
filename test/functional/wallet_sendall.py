...
class SendallTest(BitcoinTestFramework):
    ...
    def sendall_fails_with_transaction_too_large(self):
        ...
        # create many inputs (0.0001 FJAR each, enough to cover P2PKH fees
        # but tx with 1600 P2PKH inputs will exceed 100KB limit)
        outputs = {self.wallet.getnewaddress(): 0.0001 for _ in range(1600)}
