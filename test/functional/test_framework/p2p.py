...
"""Test objects for interacting with a fjarcoded node over the p2p protocol.

The P2PInterface objects interact with the fjarcoded nodes under test using the
...
class P2PInterface(P2PConnection):
    ...
    def __init__(self, support_addrv2=False, wtxidrelay=False):
        super().__init__()
