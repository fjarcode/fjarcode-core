...
class ListSinceBlockTest(BitcoinTestFramework):
    ...
    def test_double_spend(self):
        ...
        1. User 1 receives FJAR in tx1 from utxo1 in block aa1.
        2. User 2 receives FJAR in tx2 from utxo1 (same) in block bb1
    ...
    def test_label(self):
        ...
        new_addr = self.nodes[1].getnewaddress(label="new_addr", address_type="legacy")
