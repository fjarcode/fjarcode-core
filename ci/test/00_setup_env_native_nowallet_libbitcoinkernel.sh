...
export CONTAINER_NAME=ci_native_nowallet_libfjarcodekernel
...
export GOAL="install"
export FJARCODE_CONFIG="--enable-reduce-exports --enable-experimental-util-chainstate --with-experimental-kernel-lib --enable-shared"
